    ...
    return (
      <div className=" bg-white text-black top-0 left-0 right-0 bottom-0 w-screen h-screen fixed">
        <div className=" max-w-md mx-auto p-12 ">
          <RiCloseLine onClick={()=> setMenu(false)} className=" text-5xl float-right" />
          ...
          <div className=" space-y-5 mt-20">
            ...
            <div onClick={logOutUser} className="bg-[#7cfed0] text-black flex justify-center hover:shadow-xl font-nunito font-bold rounded-[20px]  px-4 sm:py-4 py-3 sm:w-[320px]  w-[280px] m-2">
              Sign Out
            </div>
          </div>
          <div className=" mx-auto flex justify-center mt-36  font-bold ">
              ...
              Created By <a className=" underline " href="#"> @pawan67</a>
              </div>
          </div>
        </div>
      </div>
